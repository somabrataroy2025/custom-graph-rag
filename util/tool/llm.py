...
doc_transformer = LLMGraphTransformer(
    llm=llm,
    allowed_nodes=["Language","KeySkill", "Email","Mobile"],
    allowed_relationships=["HAS_SKILL","PERSONAL_INFO","KNOWS_LANGUAGE"]
)

filePath = "D:\My Work\Python Work\custom-graph-rag\docs"
